...
public enum ResponseCode {
    ...
    SHIPPING_ADD_FAIL(24,"收货地址插入失败"),
    SHIPPING_DELETE_FAIL(25,"收货地址删除失败"),
    SHIPPING_UPDATE_FAIL(26,"收获地址更新失败"),
    SHIPPING_SELECT_FAIL(27,"收获地址查询失败"),
    PAY_PARAM_ERROR(28,"支付参数错误"),
    ORDER_NO_NOT_FAIL(29,"订单编号不能为空"),
    ORDER_NOT_EXISTS(30,"订单不存在"),
    ORDER_UPDATE_FAIL(31,"订单更新失败"),
    ;
